...
#include<time.h>
#define line printf("- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -\n")
#define song_info "D:\\data\\歌曲信息管理系统\\song_info.txt"
#define help_file "D:\\data\\歌曲信息管理系统\\help.txt"
#define orgin_c "D:\\data\\歌曲信息管理系统\\歌曲信息管理系统C源文件.txt"
#define backup "D:\\data\\歌曲信息管理系统\\song_backup.txt"
#define LEN1 40
#define LEN2 30
struct song{
	char name[LEN1];//歌曲名称
